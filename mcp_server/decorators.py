...
def mcp_publish_list(*args: type[APIView], name: str | None = None, instructions: str | None = None, server: TypeDjangoMcpServer | None = None, actions: dict | None = None):
    """A decorator that can be used to mark a view that uses
    ...
    def wrapper(view_class: type[APIView]):
